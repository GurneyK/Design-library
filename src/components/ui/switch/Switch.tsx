  ...
  return (
    <label className={["inline-flex cursor-pointer items-center gap-2", className].filter(Boolean).join(" ")}>
      <span className="relative inline-flex h-5 w-9 shrink-0">
        ...
        <span className="h-5 w-9 rounded-full bg-gray-200 transition peer-checked:bg-brand-600 peer-focus-visible:shadow-[var(--habibi-focus-ring)] peer-disabled:cursor-not-allowed peer-disabled:opacity-50" />
