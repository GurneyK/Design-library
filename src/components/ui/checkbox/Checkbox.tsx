  ...
  return (
    <label className={["flex cursor-pointer gap-2.5", className].filter(Boolean).join(" ")}>
      <span className="relative mt-0.5 inline-flex h-4 w-4 shrink-0">
        ...
        <span className="h-4 w-4 rounded border-2 border-gray-300 bg-white peer-checked:border-brand-600 peer-checked:bg-brand-50 peer-focus-visible:shadow-[var(--habibi-focus-ring)] peer-disabled:cursor-not-allowed peer-disabled:opacity-50" />
